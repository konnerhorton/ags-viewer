...
if AGS_VALIDATION_RESULTS:
    ...
    PROJECT_AGS_TABLES, PROJECT_AGS_HEADINGS = AGS4.AGS4_to_dataframe(PROJECT_AGS_PATH)

    PROJECT_AGS_DATA = {
        header: AGS4.convert_to_numeric(table)
        for header, table in PROJECT_AGS_TABLES.items()
    }
    st.session_state.ags_data = PROJECT_AGS_DATA
